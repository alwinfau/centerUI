    ...
    return (
        <header className="flex items-center gap-1 pb-4 px-1 border-box">
            <Button variant="quiet" slot="previous">
                {direction === 'rtl' ? <ChevronRightIcon aria-hidden className="size-[18px]" /> : <ChevronLeftIcon aria-hidden className="size-[18px]" />}
            </Button>
            ...
            <Button variant="quiet" slot="next">
                {direction === 'rtl' ? <ChevronLeftIcon aria-hidden className="size-[18px]" /> : <ChevronRightIcon aria-hidden className="size-[18px]" />}
            </Button>
        </header>
    );
}
